...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| c | l | X | c |}
        \hline
        \textbf{No.} & \textbf{Skenario} & \textbf{Keterangan} & \textbf{Status} \\ \hline
        1 & Skenario pertama & Penjelasan singkat tentang apa yang diuji & Berhasil \\ \hline
        2 & Skenario kedua & Penjelasan singkat tentang apa yang diuji & Berhasil \\ \hline
        3 & Skenario ketiga & Penjelasan singkat tentang apa yang diuji & Perlu revisi \\ \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| X | c | c | c |}
        \hline
        \textbf{Metrik} & \textbf{Sebelum} & \textbf{Sesudah} & \textbf{Perubahan} \\ \hline
        Waktu proses & 120 detik & 45 detik & $-$62\% \\ \hline
        Tingkat kesalahan & 8\% & 2\% & $-$6\% \\ \hline
        Kapasitas harian & 500 record & 1200 record & $+$140\% \\ \hline
    \end{tabularx}
\end{table}
